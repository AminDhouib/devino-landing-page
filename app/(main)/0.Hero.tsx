...
const RotateWords = ({ words }: { words: string[] }) => {
...
export default function Hero() {
  ...
  return (
    <div
      className="flex flex-col items-center justify-center min-h-screen text-center md:px-8"
      ref={ref}
    >
      <motion.div
      ...
      >
        ...
        Tomorrow’s <div className="hidden md:flex mb-5"></div>
        challenges, <div className="md:hidden mb-7"></div>
        Innovating <div className="hidden md:flex mb-5"></div>
        Beyond{" "}
