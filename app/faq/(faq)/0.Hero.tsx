...
export function WorkHero() {
  return (
    <section className="flex items-center justify-center sm:pt-[5rem] pt-[4rem] tracking-tighter max-w-[min(75rem,96svw)] sm:max-w-[100%] sm:px-6 mx-auto">
      <h1 className="font-bold text-5xl lg:text-4xl pb-6 relative dark:text-white">
        <Image
          src={"/icons/title.svg"}
          alt={"title icon"}
          height={100}
