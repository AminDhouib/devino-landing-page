...
export default function Hero() {
  return (
    <section className="pt-[12rem] md:pt-[8rem] md:pb-[5rem] pb-[14rem] text-darkblue flex items-center justify-center flex-col font-medium tracking-tighter text-center relative text-sm sm:text-xs">
      ...
      <p className="font-semibold text-2xl sm:text-sm md:text-md mt-10">
...
export const Card = ({
  ...
  return (
    <motion.p
      ...
      className={"p-3 px-7 rounded-xl shadow-sm w-max " + className}
    >
      {text}
    </motion.p>
  );
