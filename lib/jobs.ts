  ...
  positions: [
    {
      ...
      description:
          'Build and deploy machine learning models and data pipelines. Work with cutting‑edge AI technologies to solve complex business problems and drive innovation.',
      requirements: [
    ...
    },
    {
      ...
      location: 'Remote (Global)',
      description:
          'Develop end‑to‑end web applications using modern technologies. Work on both frontend and backend systems while collaborating with design and product teams.',
      requirements: [
    ...
    },
    {
      ...
      location: 'Remote (Global)',
      description:
          'Drive user acquisition and revenue growth through data‑driven marketing strategies. Optimize conversion funnels and scale marketing campaigns across multiple channels.',
      requirements: [
    ...
    },
    {
      ...
      location: 'Remote (Global)',
      description:
          'Lead development of complex web applications using modern technologies. Mentor junior developers and contribute to architectural decisions.',
      requirements: [
    ...
    },
    {
      ...
      location: 'Remote (Global)',
      description:
          'Create beautiful, user‑centered designs for web and mobile applications. Work closely with development teams to ensure pixel‑perfect implementation.',
      requirements: [
    ...
    },
    {
      ...
      location: 'Remote (Global)',
      description:
          'Build and maintain scalable cloud infrastructure. Implement CI/CD pipelines and ensure system reliability and security.',
      requirements: [
        '3+ years of DevOps or cloud experience',
    ...
    },
    {
      ...
      location: 'Remote (Global)',
      description:
          'Develop cross‑platform mobile applications using React Native. Work on exciting projects across various industries.',
      requirements: [
    ...
    },
    {
      ...
      location: 'Remote (Global)',
      description:
          'Lead cross‑functional teams to deliver projects on time and within budget. Ensure quality and client satisfaction.',
      requirements: [
    ...
    },
    {
      ...
      location: 'Remote (Global)',
      description:
          'Build responsive, interactive user interfaces using modern frontend technologies. Perfect opportunity for career growth.',
      requirements: [
